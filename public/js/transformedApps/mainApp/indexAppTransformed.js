...
/* harmony import */ var _Map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
/* harmony import */ var _Navbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _Sidebar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29);
/* harmony import */ var _InstitutionTab__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(30);
...
function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.lastClickedActionInstitutionMarker = null;
    _this.institutionData = {};
    _this.getGoogleMapInstance = _this.getGoogleMapInstance.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getInstitutionTabOpener = _this.getInstitutionTabOpener.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getInstitutionByActionId = _this.getInstitutionByActionId.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.searchInstitutionClickHandler = _this.searchInstitutionClickHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.getSelectedInstitutionData = _this.getSelectedInstitutionData.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.searchActionById = _this.searchActionById.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.loadedFbApi = _this.loadedFbApi.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  ...
  _createClass(App, [{
    key: "searchActionById",
    value: function searchActionById(actionsList, actionId) {
      var filterResult = actionsList.filter(function (action) {
    ...
    key: "getInstitutionByActionId",
    value: function getInstitutionByActionId(actionId) {
      var result = null;

      for (var i = 0; i < this.institutionData.length; i++) {
        var filterResult = this.institutionData[i].actions.filter(function (action) {
          return action.Id === actionId;
        });
    ...
    key: "getGoogleMapInstance",
    value: function getGoogleMapInstance(map) {
      this.setState({
        googleMap: map
      });
    }
  }, {
    key: "getInstitutionTabOpener",
    value: function getInstitutionTabOpener(opener) {
      this.openInstitutionTab = opener;
    }
  }, {
    key: "searchInstitutionClickHandler",
    value: function searchInstitutionClickHandler(actionId) {
      var selectedInstitution = this.getInstitutionByActionId(actionId);

      if (this.lastClickedActionInstitutionMarker) {
        this.lastClickedActionInstitutionMarker.setMap(null);
      }

      this.lastClickedActionInstitutionMarker = new InstitutionMarkerOverlay(new google.maps.LatLng({
        lat: selectedInstitution.institution.Latitude,
        lng: selectedInstitution.institution.Longitude
      }), this.state.googleMap, selectedInstitution);
      this.state.googleMap.panTo(this.lastClickedActionInstitutionMarker.latLng);
    }
  }, {
    key: "getSelectedInstitutionData",
    value: function getSelectedInstitutionData() {
      if (!this.lastClickedActionInstitutionMarker) {
        return null;
      }
    ...
    value: function componentDidMount() {
      ...
      fetch("getInstitutions").then(function (res) {
        return res.json();
      }).then(function (data) {
        //console.log(data);
        _this2.institutionData = data;
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_InstitutionTab__WEBPACK_IMPORTED_MODULE_5__["default"], {
...
function (_React$Component) {
  ...
  function GoogleMap(props) {
    ...
    _this.loadedMaps = _this.loadedMaps.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.createInstitutionMarkers = _this.createInstitutionMarkers.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.updateUserLocation = _this.updateUserLocation.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.defineInstitutionCustomMarker = _this.defineInstitutionCustomMarker.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.centerMapToUserLocation = _this.centerMapToUserLocation.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.clickOpenInstitutionTabHandler = _this.clickOpenInstitutionTabHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(GoogleMap, [{
    key: "clickOpenInstitutionTabHandler",
    value: function clickOpenInstitutionTabHandler(event) {
      this.props.openInstitutionTab();
      event.preventDefault();
    }
  }, {
    key: "defineInstitutionCustomMarker",
    value: function defineInstitutionCustomMarker() {
      var openInstitutionTabHandler = this.clickOpenInstitutionTabHandler; //console.log(openInstitutionTabHandler);

      InstitutionMarkerOverlay.prototype = new google.maps.OverlayView();

      InstitutionMarkerOverlay.prototype.onAdd = function () {
        var _this2 = this;

        var clickOpenInstitutionTabHandler = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : openInstitutionTabHandler;
        var panes = this.getPanes();

        if (!this.infoWindow) {
          var infoWindowContentParent = document.createElement('div');
          ...
          tabParagraph.appendChild(link); //add the elements to the parent
        ...
        if (!this.div_) {
          ...
          this.div_.addEventListener('click', function (event) {
            _this2.infoWindow.open(_this2.getMap());
          });
        }

        this.infoWindow.open(this.getMap()); //console.log("added");
      ...
      InstitutionMarkerOverlay.prototype.onRemove = function () {
        ...
        delete this.div_;
        delete this.infoWindow; //console.log("removed");
      };
    ...
    key: "createInstitutionMarkers",
    value: function createInstitutionMarkers() {
      console.log(this.props);
      var markers = [];

      for (var i = 0; i < this.props.institutionData.length; i++) {
        markers.push(new InstitutionMarkerOverlay(new google.maps.LatLng({
    ...
    key: "componentDidMount",
    value: function componentDidMount() {
      var script = document.createElement('script'); //Filipoiu : AIzaSyA2qWH_SXI2SbE3DBkgzvZVpgtvDV8wDgo
    ...
    value: function centerMapToUserLocation(event) {
    ...
    value: function updateUserLocation(pos) {
    ...
    value: function loadedMaps() {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.watchPosition(this.updateUserLocation, function () {
    ...
    key: "render",
    value: function render() {
      var loader = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null);
      var currentPositionButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null);
      ...
      if (!this.map) {
        ...
        currentPositionButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "currentPositionButton",
          onClick: this.centerMapToUserLocation
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
...
function (_React$Component) {
  ...
  function Navbar(props) {
    ...
    _this.actionSearchHandler = _this.actionSearchHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.clearButtonClickHandler = _this.clearButtonClickHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.filterActionsByName = _this.filterActionsByName.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.formSubmitHandler = _this.formSubmitHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(Navbar, [{
    key: "actionSearchHandler",
    value: function actionSearchHandler(event) {
    ...
    key: "clearButtonClickHandler",
    value: function clearButtonClickHandler(event) {
    ...
    key: "filterActionsByName",
    value: function filterActionsByName() {
      var _this2 = this;

      var result = [];
      this.props.institutionData.filter(function (inst) {
        result.push({
          'id': inst.Id,
          'actions': []
        });
        inst.actions.filter(function (action) {
          //make a case insensitive matching
          if (action.Name.toLowerCase().match(new RegExp(_this2.state.searchActionValue.toLowerCase()))) {
    ...
    value: function render() {
      ...
      if (this.state.searchActionValue.length > 0) {
        var instActions = this.filterActionsByName();

        for (var i = 0; i < instActions.length; i++) {
          instActions[i].actions.map(function (action, i) {
            //console.log(action);
            filterResult.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
              className: "mdl-list__item",
              key: 'action_' + action.Id,
              onClick: function onClick() {
                _this3.props.institutionClickHandler(action.Id);
              }
        ...
        if (filterResult.length == 0) {
          actionsDropdown = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
            className: "mdl-list",
            key: "dropdown-list"
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("header", {
        className: "mdl-layout__header navbar"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-layout__header-row"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
        className: "searchActionForm mdl-cell--6-col mdl-cell--4-col-phone",
        action: "#",
        ...
        className: "material-icons"
      }, "clear")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_1__["CSSTransition"], {
...
var _ReplaceTransition = _interopRequireDefault(__webpack_require__(26));

var _TransitionGroup = _interopRequireDefault(__webpack_require__(27));
...
var _addClass = _interopRequireDefault(__webpack_require__(19));

var _removeClass = _interopRequireDefault(__webpack_require__(22));
...
var _hasClass = _interopRequireDefault(__webpack_require__(21));
...
var _ChildMapping = __webpack_require__(28);
...
function (_React$Component) {
  ...
  function Sidebar(props) {
    ...
    _this.fbLoginClickHandler = _this.fbLoginClickHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(Sidebar, [{
    key: "fbLoginClickHandler",
    value: function fbLoginClickHandler(event) {
      if ((typeof FB === "undefined" ? "undefined" : _typeof(FB)) === 'object' && this.props.userData === null) {
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, " Facebook Login ")))));
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return InstitutionTab; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_transition_group__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ActionSteps__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(InstitutionTab, _React$Component);

  function InstitutionTab(props) {
    var _this;

    _classCallCheck(this, InstitutionTab);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(InstitutionTab).call(this, props));
    _this.state = {
      isOpen: false,
      selectedInstitution: null,
      selectedAction: null
    };
    _this.openTab = _this.openTab.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.closeTab = _this.closeTab.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.clickActionHandler = _this.clickActionHandler.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.switchToActionsList = _this.switchToActionsList.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(InstitutionTab, [{
    key: "clickActionHandler",
    value: function clickActionHandler(actionId) {
      this.setState({
    ...
    key: "switchToActionsList",
    value: function switchToActionsList() {
      this.setState({
        selectedAction: null
      });
    }
    ...
    value: function render() {
      ...
      if (!this.state.selectedInstitution) {
        actions = [];
        actionsHeader = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, " No Possible Actions ");
      } else {
        actionsHeader = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", null, " Possible Actions: ");
        actions = this.state.selectedInstitution.institution.actions.map(function (action) {
          return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
            className: "mdl-list__item",
            key: "action" + action.Id,
            onClick: function onClick(event) {
              _this2.clickActionHandler(action.Id);
            }
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
            className: "mdl-list__item-primary-content"
          }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_1__["CSSTransition"], {
        ...
        className: "institution-tab mdl-cell--5-col mdl-cell--6-col-tablet mdl-cell--4-col-phone"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-grid"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-cell mdl-cell--10-col mdl-cell--6-col-tablet mdl-cell--3-col-phone"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", {
        style: {
          margin: '0px'
        }
      }, !this.state.selectedInstitution ? 'Institution Name' : this.state.selectedInstitution.institution.Name)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, "close"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_1__["CSSTransition"], {
        in: this.state.selectedInstitution && !this.state.selectedAction,
        classNames: "actions-list-container",
        timeout: 300
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-grid actions-list-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-cell mdl-cell--12-col"
      }, actionsHeader), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-cell mdl-cell--12-col"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        className: "mdl-list"
      }, actions)))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ActionSteps__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    key: "componentDidUpdate",
    value: function componentDidUpdate(prevProps) {//console.log(this.state);
    }
  }]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ActionSteps; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(15);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_transition_group__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _action_steps_ActionStep__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32);
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(ActionSteps, _React$Component);

  function ActionSteps(props) {
    var _this;

    _classCallCheck(this, ActionSteps);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ActionSteps).call(this, props));
    _this.state = {
  ...
  _createClass(ActionSteps, [{
    ...
    value: function render() {
      ...
      if (this.props.selectedAction) {
        dots = this.props.selectedAction.instructions.map(function (el, i) {
          var classNames = "dot";

          if (i <= _this2.state.currentInstructionIndex) {
        ...
        var pxOffset = (12 * dots.length + 4 * (dots.length - 1)) / 2;
        dotsLeftDistance = 'calc(50% - ' + pxOffset.toString() + "px)";
      }

      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_1__["CSSTransition"], {
        in: this.props.isOpen === null ? false : this.props.isOpen,
        classNames: "action-steps-container",
        timeout: 300
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-grid action-steps-container"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-cell mdl-cell--2-col mdl-cell--1-col-tablet mdl-cell--1-col-phone"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        className: "material-icons back-button",
        onClick: function onClick(event) {
          _this2.props.switchToActionsList();
        }
      }, "arrow_back_ios")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mdl-cell mdl-cell--10-col mdl-cell--7-col-tablet mdl-cell--3-col-phone"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h5", {
        className: "instruction-name"
      }, "Instruction Name")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "progress-bar",
        style: {
          'left': dotsLeftDistance
        }
      }, dots))));
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      console.log(this.props); //console.log(prevProps, this.props);
    }
  }]);
